...
let ticketPriceTotal = runners.reduce((a, runner) => a + runner.donation, 0);
...
// Problem 1
// Select the first 10 runners.
let firstTen = runners.filter(runner => runner.id <= 10);
console.log(firstTen);

// Problem 2
// List all of the emails.
let allEmails = runners.map(runner => runner.email);
console.log(allEmails);

// Problem 3
// Find the highest donation amount.
let highest = runners.reduce((a, item) => item.donation > a.donation ? item : a);
console.log(highest.donation);